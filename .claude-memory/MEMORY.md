...
- [🧱 Roadmap block system](project_block_system_roadmap.md) — fasi 0-4: stile per-blocco, rich-text Tiptap minimale, media library, pattern, sito autonomo (dati = contenuti piattaforma condivisi app+sito)
