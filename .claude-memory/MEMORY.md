...
- [🧩 Grid liste admin (sforo riga)](reference_grid_liste_admin.md) — display:grid senza gridTemplateColumns si dimensiona sul contenuto → riga fuori dalla scheda + niente puntini; fix minmax(0,1fr)
