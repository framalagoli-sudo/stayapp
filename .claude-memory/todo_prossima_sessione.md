...
- ➡️ **Prossimo: F3** = applicare il profilo alla nascita + «Aggiungi funzioni». PRIMO CAMBIO VISIBILE: chiedere a Francesco prima. Serve anche l'interruttore delle funzioni di livello azienda (oggi non esiste) e colonne `profilo`/`profilo_versione` sull'entità.
