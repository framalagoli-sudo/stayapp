        ...
        return (
          <section key="newsletter" style={{ padding: '80px 0', background: primary }}>
            <div className="land-section" style={{ maxWidth: 560, textAlign: 'center' }}>
              ...
              <NewsletterForm aziendaId={ristorante.azienda_id} primary={primary} privacyUrl={`/r/${ristorante.slug}/privacy`} />
            </div>
          </section>
        )
      ...
      <footer style={{ background: '#111', padding: '28px 24px', textAlign: 'center' }}>
        ...
        {ristorante.slug && (
          <p style={{ fontSize: 11, color: '#888', marginTop: 8 }}>
            <a href={`/r/${ristorante.slug}/privacy`} style={{ color: '#aaa', textDecoration: 'none', marginRight: 12 }}>Privacy Policy</a>
            <a href={`/r/${ristorante.slug}/cookie`}  style={{ color: '#aaa', textDecoration: 'none' }}>Cookie Policy</a>
          </p>
        )}
      </footer>
