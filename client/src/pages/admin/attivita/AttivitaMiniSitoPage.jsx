...
export default function AttivitaMiniSitoPage() {
  ...
  return (
    <div style={{ maxWidth: 640 }}>
      ...
      {/* Tab bar */}
      <style>{`.sito-tabs-a::-webkit-scrollbar{display:none}`}</style>
      <div className="sito-tabs-a" style={{ display: 'flex', gap: 8, overflowX: 'auto', paddingBottom: 4, marginBottom: 20, scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch' }}>
        {TABS.map(t => (
