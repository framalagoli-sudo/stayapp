    ...
    <div style={{ maxWidth: 640 }}>
        ...
        <div style={cardStyle}>
          ...
          <div style={fieldWrap}>
            ...
            <input value={form.tagline} onChange={e => setForm(f => ({ ...f, tagline: e.target.value }))}
              ...
              placeholder="es. Cucina tradizionale toscana dal 1985" style={inputStyle} />
          </div>
          <div style={fieldWrap}>
            ...
            <input type="url" value={form.booking_url} onChange={e => setForm(f => ({ ...f, booking_url: e.target.value }))}
              onBlur={() => save({ minisito: form }).catch(() => {})}
              placeholder="https://www.thefork.it/ristorante/..." style={inputStyle} />
        ...
        <div style={cardStyle}>
          ...
          <div style={fieldWrap}>
            ...
            <input value={form.seo_title} onChange={e => setForm(f => ({ ...f, seo_title: e.target.value }))}
              onBlur={() => save({ minisito: form }).catch(() => {})}
              placeholder={`${ristorante.name} — Ristorante a ${ristorante.address || '...'}`} style={inputStyle} />
      ...
      {activeTab === 'highlights' && <>
        <div style={cardStyle}>
          ...
          <p style={{ fontSize: 13, color: '#888', marginBottom: 16, marginTop: -8 }}>
            Fino a 6 card con icona e testo (es. "Cucina a km zero", "Vini naturali", "Chef stellato").
          </p>
            ...
            return (
              <div key={h.id} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                ...
                <input value={h.text}
                  ...
                  onBlur={() => save({ minisito: form }).catch(() => {})}
                  placeholder="es. Cucina a km zero, ingredienti locali" style={{ ...inputStyle, flex: 1 }} />
          ...
          {(form.highlights || []).length < 6 && (
            <button onClick={addHighlight} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 600, color: PRIMARY, background: '#fff0f1', border: 'none', borderRadius: 8, padding: '8px 14px', cursor: 'pointer', marginTop: 4 }}>
        ...
        <div style={cardStyle}>
          ...
          <p style={{ fontSize: 13, color: '#888', marginBottom: 16, marginTop: -8 }}>
            Fino a 4 statistiche in una banda scura d'impatto (es. "500+ Coperti a settimana", "Michelin 2024").
          </p>
          {(form.stats || []).map(s => (
            <StatItem key={s.id} item={s} onPatch={p => updateStat(s.id, p)} onRemove={() => removeStat(s.id)} />
          ))}
          {(form.stats || []).length < 4 && (
            <button onClick={addStat} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 600, color: PRIMARY, background: '#fff0f1', border: 'none', borderRadius: 8, padding: '8px 14px', cursor: 'pointer', marginTop: 4 }}>
      ...
      {activeTab === 'offerte' && (
        <div style={cardStyle}>
          ...
          <button onClick={addPromo} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 600, color: PRIMARY, background: '#fff0f1', border: 'none', borderRadius: 8, padding: '8px 14px', cursor: 'pointer', marginTop: 4 }}>
      ...
      {activeTab === 'menu' && (
        <div style={cardStyle}>
          ...
          <button onClick={addMenuSpeciale} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 600, color: PRIMARY, background: '#fff0f1', border: 'none', borderRadius: 8, padding: '8px 14px', cursor: 'pointer', marginTop: 4 }}>
      ...
      {activeTab === 'testimonianze' && (
        <div style={cardStyle}>
          ...
          <p style={{ fontSize: 13, color: '#888', marginBottom: 16, marginTop: -8 }}>
            Inserisci recensioni reali dei tuoi clienti. Vengono mostrate come card nel sito.
          </p>
          {(form.testimonianze || []).map(t => (
            <TestimonianzaItem key={t.id} item={t} accentColor={PRIMARY}
              onPatch={p => updateTestimonianza(t.id, p)}
              onRemove={() => removeTestimonianza(t.id)} />
          ))}
          {(form.testimonianze || []).length < 10 && (
            <button onClick={addTestimonianza} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 600, color: PRIMARY, background: '#fff0f1', border: 'none', borderRadius: 8, padding: '8px 14px', cursor: 'pointer', marginTop: 4 }}>
      ...
      {activeTab === 'faq' && (
        <div style={cardStyle}>
          ...
          <button onClick={addFaq} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 600, color: PRIMARY, background: '#fff0f1', border: 'none', borderRadius: 8, padding: '8px 14px', cursor: 'pointer', marginTop: 12 }}>
        ...
        <div style={cardStyle}>
          ...
          <div style={fieldWrap}>
            ...
            <input value={form.cta_banner?.title || ''}
              ...
              onBlur={() => save({ minisito: form }).catch(() => {})}
              placeholder="es. Un'esperienza gastronomica unica ti aspetta" style={inputStyle} />
          </div>
          <div style={fieldWrap}>
            ...
            <input value={form.cta_banner?.subtitle || ''}
              ...
              onBlur={() => save({ minisito: form }).catch(() => {})}
              placeholder="es. Riserva il tuo tavolo per una serata indimenticabile" style={inputStyle} />
          </div>
      ...
      {activeTab === 'contenuto' && <>
        <div style={cardStyle}>
          ...
          <button onClick={() => {
            ...
            setForm(updated); save({ minisito: updated }).catch(() => {})
          }} style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 600, color: PRIMARY, background: '#fff0f1', border: 'none', borderRadius: 8, padding: '8px 14px', cursor: 'pointer', marginTop: 4 }}>
        ...
        <div style={cardStyle}>
          ...
          <p style={{ fontSize: 13, color: '#888', marginBottom: 16, marginTop: -8 }}>
            Card con icona + titolo + testo. Ottimo per filosofia cucina, specializzazioni, proposta vini, ecc.
          </p>
          <div style={fieldWrap}>
            ...
            <input value={form.paragrafi_titolo}
              ...
              onBlur={() => save({ minisito: form }).catch(() => {})}
              placeholder="es. La nostra filosofia / I nostri punti di forza" style={inputStyle} />
          </div>
        ...
        <div style={cardStyle}>
          ...
          <div style={fieldWrap}>
            ...
            <input value={form.team_titolo}
              ...
              onBlur={() => save({ minisito: form }).catch(() => {})}
              placeholder="es. Il nostro team / La brigata di cucina" style={inputStyle} />
          </div>
          {(form.team || []).map((m, idx) => (
        ...
        <div style={cardStyle}>
          ...
          <div style={fieldWrap}>
            ...
            <input value={form.steps_titolo}
              ...
              onBlur={() => save({ minisito: form }).catch(() => {})}
              placeholder="es. Come prenotare / La tua esperienza" style={inputStyle} />
          </div>
  ...
  return (
    <div style={{ paddingBottom: 20, marginBottom: 20, borderBottom: borderBottom ? '1px solid #f0f0f0' : 'none', display: 'flex', gap: 14 }}>
      <div style={{ flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
        <div style={{ width: 72, height: 72, borderRadius: '50%', overflow: 'hidden', background: '#fff0f1', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '2px solid #eee' }}>
  ...
  return (
    <div style={{ paddingBottom: 16, marginBottom: 16, borderBottom: borderBottom ? '1px solid #f0f0f0' : 'none' }}>
      <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
        <div style={{ width: 32, height: 32, borderRadius: '50%', background: PRIMARY, color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 800, flexShrink: 0, marginTop: 6 }}>{index + 1}</div>
        <div style={{ flex: 1 }}>
