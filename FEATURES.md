...
Stessa giornata: — **identità**: secondo fattore obbligatorio su tutte le aziende (e predefinito per le nuove) + **passkey** attive, riconosciute come accesso completo. Restano aperti audit log e `.single()` di AuthContext. Vedi la sessione 2026-08-18 e la nota 25 in `CLAUDE.md`.
