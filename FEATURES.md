...
Ultima revisione: **2026-09-24/25** — **il pannello si organizza per categoria, con il sito in cima.** Menu nuovo (Il tuo sito · Contenuti · Clienti · Promozione · Impostazioni; «Sito web» era la voce 27 di 43, ora è la prima). **Categorie per entità** decise da OltreNova (8 profili di mestiere, pagina «Funzioni e profili»: uso reale, editor con anteprima, assegnazione), applicate a tutti i clienti e obbligatorie alla nascita: un titolare vede 21–30 voci invece di 41, e niente con contenuti o già usato viene nascosto. **Cancellare un'azienda porta via tutto**, account compresi. 🔴 Chiuso un buco: un'azienda poteva staccare i domini di un'altra. Dettaglio → note 49–52 in `CLAUDE.md`, migration 127–129.
Precedente: **2026-09-23 (pomeriggio)** — **sessione di strategia, nessun codice.** Nasce `STRATEGIA.md`, il documento cardine: B+C adesso (servizio «fatto con te» + verticale locali/eventi), fondamenta self-serve in parallelo; **preconfiguratori per mestiere approvati** (progetto in §6.1); aggregatore locale **sì come direzione, no come prossimo passo**, con sei vincoli da rispettare da subito (§6.2). ⚠️ La sezione «Go-to-market: modello ibrido» del 16/05 qui sotto è **superata** da `STRATEGIA.md` (il white-label è ora fra le cose da non fare).
