...
export async function generateMetadata(props) {
  ...
  const description = el.seo_description || taglia(el.dati?.descrizione || el.dati?.testo || '') || property.minisito?.seo_description || ''
  ...
  const domain = (await hostUfficiale(property.id)) || searchParams?._domain
