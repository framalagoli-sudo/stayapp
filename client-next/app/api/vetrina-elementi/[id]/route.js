...
const ALLOWED = ['titolo', 'slug', 'copertina_url', 'valore_primario', 'stato_pubblico', 'num1', 'num2', 'dati', 'dati_privati', 'immagini', 'status', 'ordine', 'seo_title', 'seo_description', 'og_image_url', 'in_vendita', 'prezzo_vendita', 'stock']
