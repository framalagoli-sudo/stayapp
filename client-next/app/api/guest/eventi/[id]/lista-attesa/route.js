...
export async function POST(request, props) {
  ...
  try {
    ...
    // un'attesa senza fine, con un contatto raccolto per niente.
    if (eventoConcluso(evento)) return Response.json({ error: 'Questo evento si è già concluso.' }, { status: 400 })
