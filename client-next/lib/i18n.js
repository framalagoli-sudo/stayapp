...
const DICT = {
  it: {
    ...
    notes_opt: 'Note o richieste particolari (facoltativo)',
    phone_req: 'Telefono *',
  ...
  en: {
    ...
    notes_opt: 'Notes or special requests (optional)',
    phone_req: 'Phone *',
    switch_to_en: 'English',
    switch_to_it: 'Italiano',
    ...
    offers_tab: 'What we offer',
    events_title: 'Upcoming events',
    events_title_all: 'Events',
