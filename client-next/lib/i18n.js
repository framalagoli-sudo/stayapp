...
const DICT = {
  it: {
    ...
    cookie_notice: 'Questo sito utilizza cookie tecnici necessari al funzionamento.',
    accept: 'Accetto',
    reject: 'Rifiuta',
    events_chip: 'Eventi',
    wifi_network: 'Rete',
    ...
    rules_title: 'Regole della struttura',
    details_arrow: 'Dettagli →',
    choose_package: 'Scegli pacchetto',
    booking_sent: 'Prenotazione inviata!',
    booking_sent_sub: 'Riceverai una conferma via email.',
    seats_label: 'Posti:',
    chat_reception: 'Chat con la reception',
    chat_first: 'Scrivi il tuo primo messaggio!',
    assistant: 'Assistente',
    assistant_ai: 'Assistente AI',
    online_now: 'Online ora',
    chatbot_error: 'Mi dispiace, si è verificato un errore. Riprova tra qualche istante.',
  ...
  en: {
    ...
    cookie_notice: 'This website uses technical cookies necessary for its operation.',
    accept: 'Accept',
    reject: 'Decline',
    events_chip: 'Events',
    ...
    booking_sent_sub: 'You’ll receive a confirmation by email.',
    seats_label: 'Seats:',
    ...
    chatbot_error: 'Sorry, something went wrong. Please try again in a moment.',
