              ...
              <>
                ...
                {booking.schedule && (
                  <p style={{ margin: '0 0 14px', color: subText, fontSize: 13, display: 'flex', alignItems: 'center', gap: 4 }}>
                    <Clock size={13} strokeWidth={1.5} color={`var(--icon-color, ${primary})`} />{booking.schedule}
                  </p>
                )}
      ...
      <div style={{ padding: '14px 16px' }}>
        ...
        {item.location && (
          <div style={{ fontSize: 12, color: subText, marginBottom: 3, display: 'flex', alignItems: 'center', gap: 4 }}>
            <MapPin size={12} strokeWidth={1.5} color={`var(--icon-color, ${primary})`} />{item.location}
          </div>
        )}
        {item.schedule && (
          <div style={{ fontSize: 12, color: subText, marginBottom: 8, display: 'flex', alignItems: 'center', gap: 4 }}>
            <Clock size={12} strokeWidth={1.5} color={`var(--icon-color, ${primary})`} />{item.schedule}
          </div>
        )}
        {item.description && (
