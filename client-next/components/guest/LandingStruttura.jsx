...
const navBtnSecondary = { padding: '8px 20px', borderRadius: 50, fontSize: 13, fontWeight: 600, textDecoration: 'none', color: 'rgba(255,255,255,0.85)', border: '1px solid rgba(255,255,255,0.3)' }
